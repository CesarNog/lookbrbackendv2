...
describe('Service Tests', () => {
    ...
    describe('Inspiration Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(InspirationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/inspirations/' + 123);
            });
            it('should return Inspiration', () => {

                let entity: Inspiration;
                service.find(123).subscribe((_entity: Inspiration) => {
                    entity = _entity;
                });
