...
describe('Service Tests', () => {
    ...
    describe('Closet Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ClosetService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/closets/' + 123);
            });
            it('should return Closet', () => {

                let entity: Closet;
                service.find(123).subscribe((_entity: Closet) => {
                    entity = _entity;
                });
