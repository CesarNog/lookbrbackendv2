...
describe('Service Tests', () => {
    ...
    describe('DayTime Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(DayTimeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/day-times/' + 123);
            });
            it('should return DayTime', () => {

                let entity: DayTime;
                service.find(123).subscribe((_entity: DayTime) => {
                    entity = _entity;
                });
