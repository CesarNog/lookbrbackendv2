...
describe('Service Tests', () => {
    ...
    describe('Temperature Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(TemperatureService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/temperatures/' + 123);
            });
            it('should return Temperature', () => {

                let entity: Temperature;
                service.find(123).subscribe((_entity: Temperature) => {
                    entity = _entity;
                });
