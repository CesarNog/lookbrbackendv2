...
describe('Service Tests', () => {
    ...
    describe('SocialMedia Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SocialMediaService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/social-medias/' + 123);
            });
            it('should return SocialMedia', () => {

                let entity: SocialMedia;
                service.find(123).subscribe((_entity: SocialMedia) => {
                    entity = _entity;
                });
