    ...
    describe('Consultant Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                expect(this.lastConnection.request.url).toEqual('api/consultants/' + 123);
            });
            it('should return Consultant', () => {

                let entity: Consultant;
                service.find(123).subscribe((_entity: Consultant) => {
                    entity = _entity;
                });
