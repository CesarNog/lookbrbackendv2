...
describe('Occasion e2e test', () => {
    ...
    it('should load Occasions', () => {
        ...
        expect(occasionComponentsPage.getTitle()).toMatch(/lookbrbackendv2App.occasion.home.title/);
    ...
    it('should load create Occasion dialog', () => {
        ...
        expect(occasionDialogPage.getModalTitle()).toMatch(/lookbrbackendv2App.occasion.home.createOrEditLabel/);
