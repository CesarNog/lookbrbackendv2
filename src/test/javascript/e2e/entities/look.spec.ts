...
describe('Look e2e test', () => {
    ...
    it('should load Looks', () => {
        ...
        expect(lookComponentsPage.getTitle()).toMatch(/lookbrbackendv2App.look.home.title/);
    ...
    it('should load create Look dialog', () => {
        ...
        expect(lookDialogPage.getModalTitle()).toMatch(/lookbrbackendv2App.look.home.createOrEditLabel/);
