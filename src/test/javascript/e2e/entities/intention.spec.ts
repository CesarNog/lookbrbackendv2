...
describe('Intention e2e test', () => {
    ...
    it('should load Intentions', () => {
        ...
        expect(intentionComponentsPage.getTitle()).toMatch(/lookbrbackendv2App.intention.home.title/);
    ...
    it('should load create Intention dialog', () => {
        ...
        expect(intentionDialogPage.getModalTitle()).toMatch(/lookbrbackendv2App.intention.home.createOrEditLabel/);
