...
describe('Temperature e2e test', () => {
    ...
    it('should load Temperatures', () => {
        ...
        expect(temperatureComponentsPage.getTitle()).toMatch(/lookbrbackendv2App.temperature.home.title/);
    ...
    it('should load create Temperature dialog', () => {
        ...
        expect(temperatureDialogPage.getModalTitle()).toMatch(/lookbrbackendv2App.temperature.home.createOrEditLabel/);
