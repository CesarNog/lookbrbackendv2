...
describe('Comment e2e test', () => {
    ...
    it('should load Comments', () => {
        ...
        expect(commentComponentsPage.getTitle()).toMatch(/lookbrbackendv2App.comment.home.title/);
    ...
    it('should load create Comment dialog', () => {
        ...
        expect(commentDialogPage.getModalTitle()).toMatch(/lookbrbackendv2App.comment.home.createOrEditLabel/);
