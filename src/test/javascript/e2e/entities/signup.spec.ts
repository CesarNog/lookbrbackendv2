...
describe('Signup e2e test', () => {
    ...
    it('should load Signups', () => {
        ...
        expect(signupComponentsPage.getTitle()).toMatch(/lookbrbackendv2App.signup.home.title/);
    ...
    it('should load create Signup dialog', () => {
        ...
        expect(signupDialogPage.getModalTitle()).toMatch(/lookbrbackendv2App.signup.home.createOrEditLabel/);
