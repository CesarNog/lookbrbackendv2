...
describe('Consultant e2e test', () => {
    ...
    it('should load Consultants', () => {
        ...
        expect(consultantComponentsPage.getTitle()).toMatch(/lookbrbackendv2App.consultant.home.title/);
    ...
    it('should load create Consultant dialog', () => {
        ...
        expect(consultantDialogPage.getModalTitle()).toMatch(/lookbrbackendv2App.consultant.home.createOrEditLabel/);
