...
describe('Inspiration e2e test', () => {
    ...
    it('should load Inspirations', () => {
        ...
        expect(inspirationComponentsPage.getTitle()).toMatch(/lookbrbackendv2App.inspiration.home.title/);
    ...
    it('should load create Inspiration dialog', () => {
        ...
        expect(inspirationDialogPage.getModalTitle()).toMatch(/lookbrbackendv2App.inspiration.home.createOrEditLabel/);
