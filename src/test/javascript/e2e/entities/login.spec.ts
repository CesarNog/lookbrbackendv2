...
describe('Login e2e test', () => {
    ...
    it('should load Logins', () => {
        ...
        expect(loginComponentsPage.getTitle()).toMatch(/lookbrbackendv2App.login.home.title/);
    ...
    it('should load create Login dialog', () => {
        ...
        expect(loginDialogPage.getModalTitle()).toMatch(/lookbrbackendv2App.login.home.createOrEditLabel/);
