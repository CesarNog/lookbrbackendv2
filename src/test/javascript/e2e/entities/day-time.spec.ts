...
describe('DayTime e2e test', () => {
    ...
    it('should load DayTimes', () => {
        ...
        expect(dayTimeComponentsPage.getTitle()).toMatch(/lookbrbackendv2App.dayTime.home.title/);
    ...
    it('should load create DayTime dialog', () => {
        ...
        expect(dayTimeDialogPage.getModalTitle()).toMatch(/lookbrbackendv2App.dayTime.home.createOrEditLabel/);
