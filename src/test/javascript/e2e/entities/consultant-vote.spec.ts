...
describe('ConsultantVote e2e test', () => {
    ...
    it('should load ConsultantVotes', () => {
        ...
        expect(consultantVoteComponentsPage.getTitle()).toMatch(/lookbrbackendv2App.consultantVote.home.title/);
    ...
    it('should load create ConsultantVote dialog', () => {
        ...
        expect(consultantVoteDialogPage.getModalTitle()).toMatch(/lookbrbackendv2App.consultantVote.home.createOrEditLabel/);
