...
describe('SocialMedia e2e test', () => {
    ...
    it('should load SocialMedias', () => {
        ...
        expect(socialMediaComponentsPage.getTitle()).toMatch(/lookbrbackendv2App.socialMedia.home.title/);
    ...
    it('should load create SocialMedia dialog', () => {
        ...
        expect(socialMediaDialogPage.getModalTitle()).toMatch(/lookbrbackendv2App.socialMedia.home.createOrEditLabel/);
