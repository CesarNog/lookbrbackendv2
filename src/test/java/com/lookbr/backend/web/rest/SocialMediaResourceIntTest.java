...
public class SocialMediaResourceIntTest {
    ...
    @Autowired
    private SocialMediaSearchRepository socialMediaSearchRepository;
    ...
    public void initTest() {
        socialMediaSearchRepository.deleteAll();
    ...
    public void createSocialMedia() throws Exception {
        ...
        SocialMedia socialMediaEs = socialMediaSearchRepository.findOne(testSocialMedia.getId());
        assertThat(socialMediaEs).isEqualToIgnoringGivenFields(testSocialMedia);
    }
    ...
    public void deleteSocialMedia() throws Exception {
        ...
        boolean socialMediaExistsInEs = socialMediaSearchRepository.exists(socialMedia.getId());
        assertThat(socialMediaExistsInEs).isFalse();
