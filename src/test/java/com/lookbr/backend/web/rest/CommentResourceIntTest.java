...
@SpringBootTest(classes = Lookbrbackendv2App.class)
public class CommentResourceIntTest {

    private static final String DEFAULT_COMMENT = "AAAAAAAAAA";
    private static final String UPDATED_COMMENT = "BBBBBBBBBB";

    private static final String DEFAULT_CONSULTANT_PROFILE_PHOTO = "AAAAAAAAAA";
    private static final String UPDATED_CONSULTANT_PROFILE_PHOTO = "BBBBBBBBBB";
    ...
    private static final LocalDate DEFAULT_DATE_VOTED = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATE_VOTED = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment()
            ...
            .consultantProfilePhoto(DEFAULT_CONSULTANT_PROFILE_PHOTO)
            .consultantName(DEFAULT_CONSULTANT_NAME)
            .dateVoted(DEFAULT_DATE_VOTED);
        return comment;
    }
    ...
    public void createComment() throws Exception {
        ...
        assertThat(testComment.getConsultantProfilePhoto()).isEqualTo(DEFAULT_CONSULTANT_PROFILE_PHOTO);
        assertThat(testComment.getConsultantName()).isEqualTo(DEFAULT_CONSULTANT_NAME);
        assertThat(testComment.getDateVoted()).isEqualTo(DEFAULT_DATE_VOTED);
    ...
    public void getAllComments() throws Exception {
        ...
        restCommentMockMvc.perform(get("/api/comments?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].consultantProfilePhoto").value(hasItem(DEFAULT_CONSULTANT_PROFILE_PHOTO.toString())))
            .andExpect(jsonPath("$.[*].consultantName").value(hasItem(DEFAULT_CONSULTANT_NAME.toString())))
            .andExpect(jsonPath("$.[*].dateVoted").value(hasItem(DEFAULT_DATE_VOTED.toString())));
    }
    ...
    public void getComment() throws Exception {
        ...
        restCommentMockMvc.perform(get("/api/comments/{id}", comment.getId()))
            ...
            .andExpect(jsonPath("$.consultantProfilePhoto").value(DEFAULT_CONSULTANT_PROFILE_PHOTO.toString()))
            .andExpect(jsonPath("$.consultantName").value(DEFAULT_CONSULTANT_NAME.toString()))
            .andExpect(jsonPath("$.dateVoted").value(DEFAULT_DATE_VOTED.toString()));
    }
    ...
    public void updateComment() throws Exception {
        ...
        updatedComment
            ...
            .consultantProfilePhoto(UPDATED_CONSULTANT_PROFILE_PHOTO)
            .consultantName(UPDATED_CONSULTANT_NAME)
            .dateVoted(UPDATED_DATE_VOTED);
        ...
        assertThat(testComment.getConsultantProfilePhoto()).isEqualTo(UPDATED_CONSULTANT_PROFILE_PHOTO);
        assertThat(testComment.getConsultantName()).isEqualTo(UPDATED_CONSULTANT_NAME);
        assertThat(testComment.getDateVoted()).isEqualTo(UPDATED_DATE_VOTED);
